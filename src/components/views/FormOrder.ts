...
export class FormOrder extends Form<IFormOrder> {
    ...
    private addressInputEelement: HTMLInputElement;
    ...
    constructor(container: HTMLElement, events: IEvents) {
        ...
        this.addressInputEelement = ensureElement<HTMLInputElement>('input[name="address"]', this.container);
        this.events = events;
        ...
        this.addressInputEelement.addEventListener('input', () => {
            this.events.emit('order:address', { address: this.addressInputEelement.value });
        });
    ...
    set address(address: string) {
        this.addressInputEelement.value = address;
    }
